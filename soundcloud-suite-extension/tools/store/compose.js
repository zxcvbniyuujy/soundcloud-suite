...
const shots = [
  ...
  { file: 'screenshot-5-tools', eyebrow: 'Player tools', h1: 'Every tool in the bar', sub: 'Speed, A–B loop, sleep timer, track info, a floating lyric line, and a Ctrl+K palette that reaches every setting.', ui: () => frame('cmdk', 680, `left:${COL_X + 20}px;top:118px`) + `<div class="strip" style="left:${COL_X + 20 + 48}px;top:616px;width:584px;height:56px"><img src="${dataUri('bar')}" style="width:760px;height:56px;margin-left:-176px"></div>` },
];

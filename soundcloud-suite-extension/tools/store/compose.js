...
const shots = [
  ...
  { file: 'screenshot-5-tweaks', eyebrow: 'Shuffle & tweaks', h1: 'Shuffle your whole library. Tweak everything.', sub: 'True random play across every like, with filters and listening stats. Ninety switches behind one search box.', ui: () => card('hub-gear', 22, 'left:640px;top:44px') },
];
